...
# Edit RUN_002 - Dancer_strips_in_club.yaml and regenerate with:
#     from app.services.yaml_service import generate_py_from_yaml
#     generate_py_from_yaml(Path("RUNS/RUN_002 - Dancer_strips_in_club.yaml"))
# Generated: 2026-08-17 20:57:02
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
PROJECT_FOLDER = 'E:\\FILMY\\RUN_002 - Dancer_strips_in_club'
...
FLOW_FULL = [
    {
        'file': '01.01. girldance.mp4',
        'backend': 'local',
        'duration': 2,
        'pos': '2-second sensual club transition: sexy girl dancing slowly under neon lights, smooth body movement, dark nightclub vibe, cinematic slow-motion flow into next scene',
    ...
    {
        'file': '01.04. girldance.mp4',
        'pos': '2-second sensual club transition: sexy girl dancing slowly under neon lights, smooth body movement, dark nightclub vibe, cinematic slow-motion flow into next scene',
        'neg': 'fast motion, rushed, aggressive movement, ripping clothes, sudden actions, blurry, distorted',
        'duration': 2,
    },
    {
        'file': '01.05. girldance.mp4',
        'pos': '2-second sensual club transition: sexy girl dancing slowly under neon lights, smooth body movement, dark nightclub vibe, cinematic slow-motion flow into next scene',
        'neg': 'jerky motion, sudden pull, throwing clothes, fast undressing, abrupt movements, teleporting, blurry',
        'duration': 2,
    },
    {
        'file': '01.06. girldance.mp4',
        'pos': 'Sensual slow-motion transition: a seductive girl dancing in a dark nightclub under pulsing neon lights, she slowly begins to slide down the straps of her tight dress with both hands, teasingly pulling the fabric lower across her shoulders and chest, body moving fluidly to the beat, cinematic lighting, motion blur, dreamy and erotic atmosphere, transitions smoothly into the next scene',
        'neg': 'falling, dropping down, sudden sit, jerky movement, losing balance, abrupt motion, distorted',
        'duration': 3,
    },
    {
        'file': '01.07. girldance.png',
        'pos': 'Sensual slow-motion transition: a seductive girl dancing in a dark nightclub under pulsing neon lights, she slowly begins to slide down the straps of her tight dress with both hands, teasingly pulling the fabric lower across her shoulders and chest, body moving fluidly to the beat, cinematic lighting, motion blur, dreamy and erotic atmosphere, transitions smoothly into the next scene',
        'neg': 'jumping up, fast motion, sudden stand, jerky ascent, losing balance, abrupt movement, blurry',
        'duration': 5,
    },
    {
        'file': '01.08. girldance.png',
        'pos': 'Sensual slow-motion transition: a seductive girl dancing in a dark nightclub under pulsing neon lights, she slowly begins to slide down the straps of her tight dress with both hands, teasingly pulling the fabric lower across her shoulders and chest, body moving fluidly to the beat, cinematic lighting, motion blur, dreamy and erotic atmosphere, transitions smoothly into the next scene',
