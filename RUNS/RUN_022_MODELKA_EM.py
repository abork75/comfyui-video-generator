...
# Edit RUN_022_MODELKA_EM.yaml and regenerate with:
#     from app.services.yaml_service import generate_py_from_yaml
#     generate_py_from_yaml(Path("RUNS/RUN_022_MODELKA_EM.yaml"))
# Generated: 2026-07-19 20:52:53
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
FLOW_FULL = [
...

    {
        "chain": [
            {
                'duration': 3,
                'pos': """Middle Eastern woman, light skin, slightly wrinkled face, medium brown shoulder-length straight hair. The same woman now having sex in doggystyle position with the man. From an overhead perspective, she is on all fours with her back facing the camera. A man is positioned behind her. his hand gripping her hips as he penetrates her from behind. The woman's expression changes throughout the scene, showing moments of pleasure and engagement with her partner. Her legs are spread apart with the man in-between her legs.
