...
FLOW_FULL = [
...

    {
        ...
        'ambient_audio_prompt': 'Soft magical spell sounds, gentle glowing energy whooshes, subtle crystalline chimes, light mystical humming, quiet sparkling particles,',
        'ambient_audio_negative_prompt': 'ambient sounds, background noise, room tone, wind, footsteps, continuous atmosphere, music, heavy bass, explosions, screaming, talking in normal language, silence, distorted audio',
    },
    {
