...
# Edit RUN_010 - postapo_girl.yaml and regenerate with:
#     from app.services.yaml_service import generate_py_from_yaml
#     generate_py_from_yaml(Path("RUNS/RUN_010 - postapo_girl.yaml"))
# Generated: 2026-08-17 18:59:22
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
PROJECT_FOLDER = 'E:\\FILMY\\RUN_010 - postapo girl'
...
FLOW_FULL = [
    {
        ...
        'backend': 'linux',
        'duration': 5,
        'pos': 'Beautiful young woman standing on a street facing the camera (start frame). She smoothly turns around, walks slowly deeper into the street away from camera, bends down, picks up a laptop lying on the ground, stands back up, turns to face the camera again and holds the laptop naturally in front of her body (end frame). Realistic walking animation, natural body mechanics, smooth turning motion, detailed hand interaction when picking up the laptop, elegant and fluid sequence, 6-7 seconds, cinematic street lighting',
    ...
    },
    {
        "chain": [
            {
                'duration': 2,
                'pos': 'Woman is turning back to camera and goes down the street',
            },
            {
                'duration': 2,
